...
RUN R -e 'install.packages("pak", repos="https://packagemanager.posit.co/cran/__linux__/focal/latest")' \
    && R -e 'pak::pkg_install(c("SeuratObject@4.1.3","Seurat@4.3.0","Signac@1.11.0", "bioc::MAST@1.30.0", "bioc::DESeq2@1.44.0", "optparse", "bioc::scDblFinder@1.18.0", "harmony@1.2.0", "tidyverse@2.0.0", "hdf5r", "bioc::glmGamPoi"))' \
    # clean pak cache
