...
RUN R -e 'install.packages("pak", repos="https://packagemanager.posit.co/cran/__linux__/focal/latest")' \
    && R -e 'pak::pkg_install(c("SeuratObject@4.1.3","Seurat@4.3.0","Signac@1.11.0", "immunogenomics/presto@1.0.0", "bioc::MAST@1.30.0", "lme4/lme4", "bioc::DESeq2@1.44.0", "optparse", "bioc::scDblFinder@1.18.0", "harmony@1.2.0", "tidyverse@2.0.0", "hdf5r", "bioc::glmGamPoi@1.16.0", "bioc::clusterProfiler@4.12.1"))' \
    # clean pak cache
